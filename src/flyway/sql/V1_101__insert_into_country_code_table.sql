INSERT INTO country_code (country_name, alpha2_code, alpha3_code, numeric_code) VALUES 
...
('Kiribati', 'KI', 'KIR', 296 ) 
, 
('Korea (the Democratic Peoples Republic of)', 'KP', 'PRK', 408 ) 
, 
...
, 
('Lao Peoples Democratic Republic (the)', 'LA', 'LAO', 418 ) 
, 
('Latvia', 'LV', 'LVA', 428 ) 
, 
('Lebanon', 'LB', 'LBN', 422 ) 
